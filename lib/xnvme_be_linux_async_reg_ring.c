...
int
xnvme_be_linux_reg_ring_init(struct xnvme_queue *q, int opts)
{
...
int
xnvme_be_linux_reg_ring_term(struct xnvme_queue *q)
{
	struct xnvme_queue_liburing *queue = (void *)q;
	int err;
...
int
xnvme_be_linux_reg_ring_poke(struct xnvme_queue *q, uint32_t max)
{
	struct xnvme_queue_liburing *queue = (void *)q;
...
#ifdef NVME_URING_CMD_IO
int
xnvme_be_linux_reg_ring_io(struct xnvme_cmd_ctx *ctx, void *dbuf, size_t dbuf_nbytes, void *mbuf,
		       size_t mbuf_nbytes)
{
...
int
xnvme_be_linux_reg_ring_iov(struct xnvme_cmd_ctx *ctx, struct iovec *dvec, size_t dvec_cnt,
...
struct xnvme_be_async g_xnvme_be_linux_async_reg_ring = {
	.id = "reg_ring",
#ifdef XNVME_BE_LINUX_LIBURING_ENABLED
	.cmd_io = xnvme_be_linux_reg_ring_io,
	.cmd_iov = xnvme_be_linux_reg_ring_iov,
	.poke = xnvme_be_linux_reg_ring_poke,
	.wait = xnvme_be_nosys_queue_wait,
	.init = xnvme_be_linux_reg_ring_init,
	.term = xnvme_be_linux_reg_ring_term,
